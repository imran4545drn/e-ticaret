				...
				<div class="mb-6">
					...
					<div class="grid grid-cols-2 gap-4">
						...
						<div>
							...
							<input wire:model='last_name' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="last_name" type="text">
							</input>
                            @error('last_name')
                            <div class="text-red-500 text-sm">{{$message}}</div>
					...
					<div class="mt-4">
						...
						<input wire:model='phone' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="phone" type="text">
						</input>
                        @error('phone')
                        <div class="text-red-500 text-sm">{{$message}}</div>
					...
					<div class="mt-4">
						...
						<input wire:model='street_adress' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="address" type="text">
						</input>
                        @error('street_adress')
                        <div class="text-red-500 text-sm">{{$message}}</div>
					...
					<div class="mt-4">
						...
						<input wire:model='city' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="city" type="text">
						</input>
                        @error('city')
                        <div class="text-red-500 text-sm">{{$message}}</div>
					...
					<div class="grid grid-cols-2 gap-4 mt-4">
						<div>
							...
							<input wire:model='state' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="state" type="text">
							</input>
                            @error('state')
                            <div class="text-red-500 text-sm">{{$message}}</div>
						...
						<div>
							...
							<input wire:model='zip_code' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="zip" type="text">
							</input>
                            @error('zip_code')
                            <div class="text-red-500 text-sm">{{$message}}</div>
        ...
        <li class="py-3 sm:py-4" wire:key="{{ $ci['product_id'] }}">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img src="{{ url('storage', $ci['image']) }}" alt="{{ $ci['name'] }}" class="w-12 h-12 rounded-full">
                </div>
