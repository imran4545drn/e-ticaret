          ...
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <ul>
                ...
                <li class="mb-4" wire:key="{{$brandd->id}}">
                    <label for="{{$brandd->slug}}" class="flex items-center dark:text-gray-300">
                      <input type="checkbox"  wire:model.live="selected_brands"         id ="{{$brandd->slug}}"    value="{{$brandd->id}}" class="w-4 h-4 mr-2">
                      <span class="text-lg dark:text-gray-400">{{$brandd->name}}</span>
                    </label>
                  </li>
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div class="font-semibold">{{Number::currency($price_range)}}</div>
                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="300000" value="300000" step="1000">
                ...
                <div class="border border-gray-300 dark:border-gray-700">
                  <div class="relative bg-gray-200">
                    <a href="/products/{{$product->slug}}" class="">
                        <img src="{{ url('storage', $product->images[0] ?? 'default.jpg') }}" alt="{{ $product->name }}" class="object-cover w-full h-56 mx-auto">
                  ...
                  <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                    ...
                    <a wire:click.prevent ="addToCart({{ $product->id}})" class="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
